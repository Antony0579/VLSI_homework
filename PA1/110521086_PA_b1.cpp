...
//--------------------------------------------//找到分支來源並整理為輸出形式
string find_wireout(string impt,string acol3_1,string awire45, string aST) {
...
//--------------------------------------------//處理分支
string lo_con(string impt, string rd0,int conleng, string COL00,string wire45b, string STb){

    if (rd0.length() >= conleng ){
        string col3_1 = rd0.substr(conleng-maxn,maxn);
        string bcol3_1 = find_wireout(impt,col3_1, wire45b, STb); 
        COL00 = ", gat" + bcol3_1;
    }else{ COL00 ="";}
...
//--------------------------------------------//處理分支1234
string logic_wire(string impt,int zcol1,string zwire_c1,string zmat5,string zs,string zST){
                        
    string rdl1 = read_bfline(zcol1); 
    string aCOL1,aCOL2,aCOL3,aCOL4;

    aCOL1 = lo_con(impt,rdl1 ,6 ,aCOL1 ,zwire_c1, zST); 
    aCOL2 = lo_con(impt,rdl1 ,12 ,aCOL2 ,zwire_c1, zST);
    aCOL3 = lo_con(impt,rdl1 ,18 ,aCOL3 ,zwire_c1, zST);
    aCOL4 = lo_con(impt,rdl1 ,24 ,aCOL4 ,zwire_c1, zST);

    zmat5 =  aCOL1 + aCOL2 + aCOL3 + aCOL4 + ");"; 
...
//------------------------------------------------//wire跟out統一成陣列，之後放進for loop
            int ar_wire[6] = {wire01,wire02,wire03,wire04,wire05,wire06};
            int ar_out[6] = {outputnum01,outputnum02,outputnum03,outputnum04,outputnum05,outputnum06};
            string ar_logic[6] = {"and gat","nand gat","or gat","nor gat","not gat","buf gat",};        
...
//------------------------------------------------//符合條件者進行處理分支
            if (wire01 == 11){
                ...
                wire_c += wire441 +",";  
                mat5 = logic_wire(impt, col1,wire_c,mat5,s,ST);         
            }            
            if (wire02 == 11){
                col2 = col +1;                 
                string wire442 = numc(wire02,s);  
                wire_c += wire442 +",";                           
                mat5 = logic_wire(impt,col2,wire_c,mat5,s,ST);         
            }            
            if (wire03 == 11){
                col3 = col +1; 
                string wire443 = numc(wire03,s); 
                wire_c += wire443 +","; 
                mat5 = logic_wire(impt,col3,wire_c,mat5,s,ST);
            }
            if (wire04 == 11){
                col4 = col +1; 
                string wire444 = numc(wire04,s); 
                wire_c += wire444 +","; 
                mat5 = logic_wire(impt,col4,wire_c,mat5,s,ST);
            }
            if (wire05 == 11){
                col5 = col +1; 
                string wire445 = numc(wire05,s); 
                wire_c += wire445 +",";
                mat5 = logic_wire(impt,col5,wire_c,mat5,s,ST); 
            }
            if (wire06 == 11){
                col6 = col +1; 
                string wire446 = numc(wire06,s); 
                wire_c += wire446 +","; 
                mat5 = logic_wire(impt,col6,wire_c,mat5,s,ST);
            }
            col += 1; 
